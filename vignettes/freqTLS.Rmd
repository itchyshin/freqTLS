...
**"trace helpers"** box separates the planned user-facing scenario builder from
the internal repair-rate helper already used by `predict_heat_injury()`; neither
is part of the primary fitting workflow.
