...
# pkgdown copying a co-located static asset. Blank lines are dropped so pandoc
# keeps it as a single raw-HTML block; accessibility is the SVG's <title>/<desc>.
svg_lines <- readLines("freqTLS_function_map.svg", warn = FALSE)
cat(svg_lines[nzchar(trimws(svg_lines))], sep = "\n")
```
