...
installed datasets. It is hidden to keep this article readable; the five case
articles show the same preparation and fitting code in full.

```{r freq-fits, include=FALSE}
data(zebrafish_o2)
