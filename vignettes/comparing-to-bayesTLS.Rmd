...
The bundled benchmark datasets retain their own source-specific rights. See the
relevant data help page, `inst/COPYRIGHTS`, and the component rights ledger;
do not infer a redistribution licence merely from the `bayesTLS` comparison.
