...
t_wald <- system.time(invisible(confint(sp_fit$fit, c("CTmax", "z"), method = "wald")))[["elapsed"]]
t_prof <- system.time(invisible(confint(sp_fit$fit, c("CTmax", "z"), method = "profile")))[["elapsed"]]
