...
clutch size. freqTLS 0.1.0 implements neither. Use the corresponding
bayesTLS Case 4.2 sections for those analyses rather than treating the
count model above as a replacement.
