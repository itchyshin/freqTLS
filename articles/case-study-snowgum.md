...
current source under CC BY-NC 4.0. The development package records
coauthor authorization for the current non-commercial GitHub/pkgdown
teaching use. That does not establish unrestricted/commercial downstream
rights: CRAN remains blocked until the broader written grant is
archived. See `inst/COPYRIGHTS` and the licence ledger.
