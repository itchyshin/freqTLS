...
clearest value-add over the Bayesian path, which has no data-adequacy
guard on the model-fitting side (see
`docs/design/90-bayesTLS-critique.md`). The twelve warnings in SPEC.md
S10 split into two groups:
