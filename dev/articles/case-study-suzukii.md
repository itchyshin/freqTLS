...
The pinned bayesTLS supplement also teaches the equivalent
midpoint-coordinate formulation. freqTLS keeps the direct `CTmax`/`z`
coordinates because they are profile-able. It does not report `Tcrit` as
a Case 4 result.
