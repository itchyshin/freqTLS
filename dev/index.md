...
- Derives critical temperatures —
  ...
  See
  [`vignette("frequentist-and-bayesian")`](https://itchyshin.github.io/freqTLS/dev/articles/frequentist-and-bayesian.md)
...
| Speed | Sampling (seconds to minutes) | Optimisation (~ms to ~1 s; see the timing table in [`vignette("comparing-to-bayesTLS")`](https://itchyshin.github.io/freqTLS/dev/articles/comparing-to-bayesTLS.md)) |
...
documented in
[`vignette("comparing-to-bayesTLS")`](https://itchyshin.github.io/freqTLS/dev/articles/comparing-to-bayesTLS.md):
...
The no-random-effects path stays byte-identical to the fixed-effects
model.
...
See
[`vignette("freqTLS")`](https://itchyshin.github.io/freqTLS/dev/articles/freqTLS.md)
for the full walkthrough,
[`vignette("model-math")`](https://itchyshin.github.io/freqTLS/dev/articles/model-math.md)
for the exact bridge to `bayesTLS`, and
[`vignette("profile-likelihood")`](https://itchyshin.github.io/freqTLS/dev/articles/profile-likelihood.md)
