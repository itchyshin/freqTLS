...
- [`get_z_summary()`](https://itchyshin.github.io/freqTLS/dev/reference/tdt-accessors.md)
  [`get_z_draws()`](https://itchyshin.github.io/freqTLS/dev/reference/tdt-accessors.md)
  [`get_ctmax_summary()`](https://itchyshin.github.io/freqTLS/dev/reference/tdt-accessors.md)
  [`get_ctmax_draws()`](https://itchyshin.github.io/freqTLS/dev/reference/tdt-accessors.md)
  [`get_tcrit_summary()`](https://itchyshin.github.io/freqTLS/dev/reference/tdt-accessors.md)
  [`get_tcrit_draws()`](https://itchyshin.github.io/freqTLS/dev/reference/tdt-accessors.md)
...
- [`fit_tls()`](https://itchyshin.github.io/freqTLS/dev/reference/fit_tls.md)
  ...
  likelihood
- [`tls_bf()`](https://itchyshin.github.io/freqTLS/dev/reference/tls_bf.md)
  : Build a freqTLS formula object (brms/drmTMB-style)
- [`print(`*`<profile_tls>`*`)`](https://itchyshin.github.io/freqTLS/dev/reference/profile_tls-methods.md)
  [`summary(`*`<profile_tls>`*`)`](https://itchyshin.github.io/freqTLS/dev/reference/profile_tls-methods.md)
  [`print(`*`<summary.profile_tls>`*`)`](https://itchyshin.github.io/freqTLS/dev/reference/profile_tls-methods.md)
  [`coef(`*`<profile_tls>`*`)`](https://itchyshin.github.io/freqTLS/dev/reference/profile_tls-methods.md)
  [`vcov(`*`<profile_tls>`*`)`](https://itchyshin.github.io/freqTLS/dev/reference/profile_tls-methods.md)
  [`logLik(`*`<profile_tls>`*`)`](https://itchyshin.github.io/freqTLS/dev/reference/profile_tls-methods.md)
  [`AIC(`*`<profile_tls>`*`)`](https://itchyshin.github.io/freqTLS/dev/reference/profile_tls-methods.md)
  [`nobs(`*`<profile_tls>`*`)`](https://itchyshin.github.io/freqTLS/dev/reference/profile_tls-methods.md)
...
- [`get_ctmax()`](https://itchyshin.github.io/freqTLS/dev/reference/get_ctmax.md)
  : Extract the CTmax estimate(s)
- [`get_z()`](https://itchyshin.github.io/freqTLS/dev/reference/get_z.md)
  : Extract the thermal-sensitivity (z) estimate(s)
- [`get_shape()`](https://itchyshin.github.io/freqTLS/dev/reference/get_shape.md)
...
- [`binomial_tls()`](https://itchyshin.github.io/freqTLS/dev/reference/tls_family.md)
  [`beta_binomial_tls()`](https://itchyshin.github.io/freqTLS/dev/reference/tls_family.md)
  [`beta_tls()`](https://itchyshin.github.io/freqTLS/dev/reference/tls_family.md)
...
- [`profile(`*`<profile_tls>`*`)`](https://itchyshin.github.io/freqTLS/dev/reference/profile.profile_tls.md)
  [`print(`*`<profile_tls_profile>`*`)`](https://itchyshin.github.io/freqTLS/dev/reference/profile.profile_tls.md)
...
- [`predict(`*`<profile_tls>`*`)`](https://itchyshin.github.io/freqTLS/dev/reference/predict.profile_tls.md)
  [`predict(`*`<freq_tls>`*`)`](https://itchyshin.github.io/freqTLS/dev/reference/predict.profile_tls.md)
  : Predict survival, link, or midpoint from a fitted freqTLS model
- [`predict_survival_surface()`](https://itchyshin.github.io/freqTLS/dev/reference/predict_survival_surface.md)
...
- [`plot(`*`<profile_tls_profile>`*`)`](https://itchyshin.github.io/freqTLS/dev/reference/plot.profile_tls_profile.md)
...
- [`simulate_tls()`](https://itchyshin.github.io/freqTLS/dev/reference/simulate_tls.md)
...
- [`clock_to_minutes()`](https://itchyshin.github.io/freqTLS/dev/reference/clock_to_minutes.md)
  : Convert various clock formats to minutes
- [`format_interval()`](https://itchyshin.github.io/freqTLS/dev/reference/format_interval.md)
  : Format a point estimate plus confidence interval as a single string
- [`tdt_quantile()`](https://itchyshin.github.io/freqTLS/dev/reference/tdt_quantile.md)
...
- [`zebrafish_o2`](https://itchyshin.github.io/freqTLS/dev/reference/zebrafish_o2.md)
  : Zebrafish lethal-TDT data across an oxygen gradient
- [`dsuzukii`](https://itchyshin.github.io/freqTLS/dev/reference/dsuzukii.md)
  : Drosophila suzukii multi-trait thermal-tolerance data
- [`aphid_tdt`](https://itchyshin.github.io/freqTLS/dev/reference/aphid_tdt.md)
  : Cereal-aphid lethal-TDT data, three species across three ages
- [`snowgum_psii`](https://itchyshin.github.io/freqTLS/dev/reference/snowgum_psii.md)
  : Snow-gum retained PSII after heat exposure

## Package

- [`freqTLS`](https://itchyshin.github.io/freqTLS/dev/reference/freqTLS-package.md)
  [`freqTLS-package`](https://itchyshin.github.io/freqTLS/dev/reference/freqTLS-package.md)
