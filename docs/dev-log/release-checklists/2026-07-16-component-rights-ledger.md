...
| `data/snowgum_psii.rda`; `inst/extdata/data_function_PSII_TDT_snowgum.csv`; `data_function_PSII_TDT_snowgum_glasshouse.csv` | Arnold et al. (2026), bioRxiv 10.64898/2026.04.09.717599, Experiment 1; Pieter (data holder) | **CC BY-NC 4.0** stated in data help; Pieter explicitly authorised this package use (Shinichi, 2026-07-16) | exclude two post/pre rows above 1; `fvfm_prop = final_fvfm / initial_fvfm` | data help, leaf-PSII case study, beta example, cache | SHIP — retain attribution and CC BY-NC notice |
