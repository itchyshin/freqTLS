...
Generated: 2026-07-11 15:06:23 MDT
Repository: `/Users/z3437171/.codex/worktrees/freqtls-cran`
Goal: Finish freqTLS 0.1.0 CRAN readiness after Sol adversarial fixes
Suggested next step: Regenerate docs and README; update cache provenance note; rebuild pkgdown; rebuild exact tarball; rerun R CMD check --as-cran; rerun Sol Grace/Rose/Pat review; then commit, push, open PR, and run platform gates
...
```text
 ...
 inst/CITATION                                      |  23 ++++--
 inst/COPYRIGHTS                                    |  54 ++++++++++---
 inst/extdata/bayesTLS_benchmark_cache.rds          | Bin 1937 -> 1925 bytes
 man/confint.profile_tls.Rd                         |  10 +--
 ...
 59 files changed, 775 insertions(+), 445 deletions(-)
```
